...
window.HOTSEAT = {
  ...
  { name: "Big Ten", teams: 18, note: "2 in real danger", coaches: [
    ...
    { id:"locksley", coach:"Mike Locksley", team:"Maryland", prob:50, cbs:"4.9",
      ...
      notes:[
        ...
        "The dampener is the checkbook: his buyout is about $13.4M, with roughly half due within 60 days — a genuinely painful upfront number for a program that isn't flush with cash, which is the main reason this sits at a coin flip rather than at a higher probability. The schedule sets up a mirage: Maryland is heavily favored in its openers (FAU, Northern Illinois, Towson), so a 3–0 or 4–0 start is likely and will quiet the noise temporarily. The verdict comes entirely in Big Ten play, and the play of sophomore QB Malik Washington is the swing variable. If the DMV-recruited roster still loses conference games it should win, the goodwill from three prior bowls likely won't save him."
      ] },
  ...
  { name: "SEC", teams: 16, note: "2 in real danger", coaches: [
    { id:"beamer", coach:"Shane Beamer", team:"South Carolina", prob:35, cbs:"4.3",
      ...
      notes:[
        "The hottest seat in the league and the third-hottest in the country per CBS (4.3), trailing only the three unanimous 5.0s and Maryland's Mike Locksley. Beamer is coming off a 4–8 (1–7 SEC) collapse - the worst season of his tenure — one year after a nine-win breakthrough year that had South Carolina in the preseason playoff conversation. The Gamecocks lost their final five SEC games, including a blown 27-point halftime lead at Texas A&amp;M, and Beamer made his first in-season staff firings. He has publicly embraced the pressure, acknowledging he's essentially coaching for his job.",
        "Two things keep this well below a coin flip. First, the buyout is a genuine barrier, since a without-cause dismissal costs South Carolina roughly $25–28M (which grows to over $39M once assistant coach contracts are included), structured to be paid out rather than dropped as a lump sum. The second item, which distinguishes Beamer's situation from Locksley's, is that while athletic director Jeremiah Donati is technically a <em>new</em> AD who inherited Beamer, Donati <em>chose to extend Beamer</em> in January 2025, adding three years and nearly $19M in buyout. That's ownership of the hire, not indifference to it. The schedule is demanding but not the usual gauntlet, featuring two non-conference gimmes (Kent State, Towson) plus winnable SEC games (Mississippi State and Kentucky at home, Arkansas away), against a tougher run of Alabama, Florida, Tennessee, Oklahoma, Texas A&amp;M and Georgia. Bowl eligibility is the line that saves him; a second straight bowl-less year likely ends it."
      ] },
    { id:"lebby", coach:"Jeff Lebby", team:"Mississippi State", prob:28, cbs:"3.0",
      ...
      notes:[
        "This feels like the classic third-year make-or-break season for Lebby, and this is the only other SEC seat that's truly warm (3.0). Lebby is 7–18 overall and just 1–15 in SEC play across his first two seasons, though he squeaked into a bowl in 2025 (a loss) after a 2–10 debut, and notched his first conference win over Arkansas in November.",
        "The accelerants are real. AD Zach Selmon has signaled he won't wait on a flat trajectory. Mississippi State has a recent history of eating buyouts to move on quickly (e.g., Moorhead after two years). and the 2026 schedule is brutal — Alabama, Oklahoma, Missouri and Vanderbilt all appear on a slate that could plausibly produce another two- or three-win SEC season. But the dampeners are also real. The buyout is still sizable (roughly $11–12M after 2026, down from about $14.26M), Mississippi State is arguably the hardest job in the league so patience is sometimes extended by necessity, and the 2025 bowl trip bought a sliver of goodwill. This sits just behind Beamer because the CBS anchor is lower and the \"who could realistically do better here\" question is a genuine brake — but a slow start against this schedule could tip it in the direction of a firing before Halloween."
      ] },
    { id:"deboer", coach:"Kalen DeBoer", team:"Alabama", prob:3, cbs:"3.0",
      ...
      notes:[
        "The CBS number (3.0) says warm, but the balance sheet and the calendar say almost untouchable for 2026. This is expectations heat, not actual firing risk. DeBoer went 9–4 in year one and returned to the College Football Playoff in year two before a humiliating 38–3 Rose Bowl loss to Indiana, and Alabama's response was to <em>extend</em> him, not threaten him. His buyout sits in the high-$60Ms (around $67.5M), the third-largest in the sport, paid at 90% of the remaining deal. National analysts have been blunt that a near-term firing is \"unlikely\" and that Alabama \"really can't afford\" it barring scandal or a fall-off-a-cliff collapse. The pressure is unmistakable and 2027 could look different if the results stall, but an actual 2026 dismissal is incredibly unlikely."
      ] },
    { id:"sarkisian", coach:"Steve Sarkisian", team:"Texas", prob:2, cbs:"2.6",
      ...
      notes:[
        "Sark is in roughly the same shape as DeBoer, although one notch cooler (2.6). It appears that Texas is all-in — Arch Manning under center, a loaded roster, top-of-the-sport investment — which raises the expectation bar to playoff-or-bust and simultaneously makes a 2026 firing nearly impossible given the buyout and the fresh commitment. Sarkisian restored the program to national relevance with back-to-back semifinal appearances, and the heat is about whether he can win it all, not whether he keeps the job. The real referendum year, if there is one, is probably 2027. The one thing to keep an eye on is the early-season schedule, which features high-profile games against Ohio State, Tennessee, and Oklahoma. How does Texas evaluate two or three losses early on in a season when they are projected as potential title contenders?"
      ] },
  ...
  { name: "ACC", teams: 17, note: "4 in real danger", coaches: [
    ...
    { id:"belichick", coach:"Bill Belichick", team:"North Carolina", prob:30, cbs:"4.1",
      ...
      notes:[
        "A 4.1 (\"start improving now\") is extraordinary for a coach entering just his second year — a measure of how much the sport's most decorated NFL figure was expected to deliver immediately, and how underwhelming and chaotic the debut season went. The layers are unusual: a new athletic director (Newmark) with no stake in his hiring, a General Manager under suspension, and the off-field drama swirling around the program only sharpened the scrutiny.",
    ...
    { id:"obrien", coach:"Bill O'Brien", team:"Boston College", prob:22, cbs:"3.5",
      ...
      notes:[
        ...
        "What tempers the number is timing — AD Blake James already made his call, publicly retaining O'Brien for 2026 with a direct endorsement (\"the right man to be our head coach\") and a commitment to compete harder in revenue sharing. That fresh vote of confidence, plus a buyout in the ~$25M range that is real money for a private school like BC, dampens the in-season trigger. But the endorsement is conditional on progress. Another 2–10 with an AD who has already burned some credibility defending the hire flips this quickly. O'Brien has already gotten <em>one more year</em>, and there may not be another one without tangible progress."
      ] },
    { id:"narduzzi", coach:"Pat Narduzzi", team:"Pittsburgh", prob:5, cbs:"2.1",
      ...
      notes:[
        "This seat would be warmer entering year 12 if not for the emergence of true freshman quarterback Mason Heintschel, whose play brought energy back to the program. As long as he develops, Narduzzi should be fine, but a sophomore-slump regression could be a path to trouble."
      ] },
    { id:"swinney", coach:"Dabo Swinney", team:"Clemson", prob:4, cbs:"3.1",
      ...
      notes:[
        "This number is pure expectations heat, and the direct ACC analog to Kalen DeBoer at Alabama. The 3.1 rating reflects a fan base's frustration after a 7–6 season (his worst full-season finish since 2008) and a program that's slipped from its former position of dominance. But there's not any real chance of a firing. The buyout is a $57M fortress in 2026, paid in installments with no offset, on top of the cost of a replacement. AD Graham Neff endorsed Swinney after the season, and multiple national insiders describe Dabo as having \"lifetime job security.\" He is essentially unfireable this cycle regardless of the rating."
      ] },
  ...
  { name: "Big 12", teams: 16, note: "2 in real danger", coaches: [
    { id:"aranda", coach:"Dave Aranda", team:"Baylor", prob:55, cbs:"5.0",
      ...
      notes:[
        "The hottest seat in the league and one of only three coaches nationally to draw a unanimous 5.0 from CBS (alongside Norvell and Fickell). The football case is straightforward, as Aranda is 36–37 overall and just 24–30 in Big 12 play across six seasons, with the 12–2 Big 12 title run in 2021 now a distant memory. Last year's 5–7 finish included one-score losses to Houston, TCU and Arizona State that fed the \"can't close\" narrative.",
        "What separates Aranda from the other 5.0s in the country is that <em>nothing structural is holding the door shut.</em> His buyout is roughly $12M — real money, but eminently payable for a Big 12 program in the revenue-share era, and a fraction of the $30–58M barriers protecting coaches like Norvell and Sanders. He was retained last November largely by default. Former AD Mack Rhoades left the school amid scandal, the AD search dragged, and President Linda Livingstone brought Aranda back citing stability, roster retention and continued investment. New AD Doug McNamee has voiced public support — but that support is explicitly conditional, and the industry consensus is blunt: <em>win roughly eight games or be gone.</em> Aranda answered by gambling the season on former five-star DJ Lagway (a ~$3M portal QB with a 28-to-23 career TD-to-INT ratio at Florida), handing defensive play-calling to new coordinator Joe Klanderman, and rebuilding the offensive line. The schedule offers a genuine path, with two near-automatic non-conference wins (Prairie View A&amp;M, Louisiana Tech) plus a winnable Auburn opener in Atlanta, and a Big 12 draw that misses both Utah and Arizona. But the closing stretch of at BYU, Texas Tech and at Houston is where seasons like this usually unravel. This lands above a coin flip precisely because the buyout likely won't save him if the results aren't there."
      ] },
    { id:"satterfield", coach:"Scott Satterfield", team:"Cincinnati", prob:30, cbs:"3.5",
      ...
      notes:[
        ...
        "The number that keeps this from climbing higher is the buyout: fired after the 2026 season, Satterfield would be owed roughly $5.5M (down from about $11.7M a year ago, as the deal steps down) — a very manageable figure for a Big 12 athletic department under AD John Cunningham. So the money is not a barrier; the question is purely whether the on-field product justifies a change. Returning quarterback Brendan Sorsby is a real asset and the arrow on paper points up, which is why this sits below Aranda. But another autumn with no November wins and a slide out of bowl position would likely end it, and the recent history says that scenario is certainly possible."
      ] },
    { id:"sanders", coach:"Deion Sanders", team:"Colorado", prob:4, cbs:"3.1",
      ...
      notes:[
        ...
        "But the firing math barely moves, for two reasons that dwarf the on-field picture. The buyout is a big obstacle, as Colorado would owe Sanders roughly <em>$33.6M</em> to fire him before the end of 2026 (stepping down to about $25.5M in 2027), which would be cost-prohibitive for a school in CU's position. Second, the brand is close to irreplaceable — Sanders single-handedly dragged Colorado from a 1–11 afterthought into national relevance, and no athletic department willingly returns to irrelevance, particularly when the cost of that move is over $33M. The one real wildcard is that AD Rick George, Sanders' most vocal backer (\"the seat is not hot\"), is departing in spring 2026, which means a new AD inherits the situation. However, no incoming AD fires Deion Sanders over performance in year one at that price. The likelier path to a Colorado change isn't a firing at all. Sanders has battled serious health issues, including bladder-removal surgery for cancer and a history of blood clots, and a <em>voluntary</em> in-season departure for health would be a different event than the performance-based dismissal."
      ] },
