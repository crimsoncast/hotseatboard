/* =====================================================================
   ...
   (by default, everyone at 5%+). Coaches without `notes` show as plain
   text on the board and get no notes entry.
   ===================================================================== */
...
window.HOTSEAT = {
  ...
  { name: "SEC", teams: 16, note: "2 in real danger", coaches: [
    ...
    { coach:"Kalen DeBoer", team:"Alabama", prob:3, cbs:"3.0" },
    { coach:"Steve Sarkisian", team:"Texas", prob:2, cbs:"2.6" },
  ...
  { name: "ACC", teams: 17, note: "4 in real danger", coaches: [
    ...
    { coach:"Dabo Swinney", team:"Clemson", prob:4, cbs:"3.1" },
  ...
  { name: "Big 12", teams: 16, note: "2 in real danger", coaches: [
    ...
    { coach:"Deion Sanders", team:"Colorado", prob:4, cbs:"3.1" },
    { coach:"Lance Leipold", team:"Kansas", prob:3, cbs:"2.3" },
